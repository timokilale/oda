import { Receipt, UtensilsCrossed, Table as TableIcon, BarChart3, Settings, HelpCircle, LogOut, Store } from 'lucide-react';
    ...
    <>
      <aside className="hidden md:flex flex-col h-screen fixed left-0 top-0 border-r border-[#E5E7EB] bg-[#f3f4f5] dark:bg-neutral-900 w-64 z-40">
        ...
        <div className="px-3 py-4 border-t border-[#E5E7EB] mt-auto">
          <button
            onClick={() => alert('Support portal is loading... Our specialist will contact you shortly.')}
